...
summaryh(lm(importance ~ dwell * timepoint, d3_feed_cc_timed[topic=="willsmith"]))
summaryh(lm(importance ~ engage * timepoint, d3_feed_cc_timed[topic=="willsmith"]))
summaryh(lm(newsworthiness ~ dwell * timepoint, d3_feed_cc_timed[topic=="willsmith"]))
summaryh(lm(newsworthiness ~ engage * timepoint, d3_feed_cc_timed[topic=="willsmith"]))


plot_cme(lm(importance ~ dwell * timepoint, d3_feed_cc_timed[topic=="willsmith"]), effect = "dwell", condition = "timepoint")
plot_cme(lm(importance ~ engage * timepoint, d3_feed_cc_timed[topic=="willsmith"]), effect = "engage", condition = "timepoint")
plot_cme(lm(newsworthiness ~ dwell * timepoint, d3_feed_cc_timed[topic=="willsmith"]), effect = "dwell", condition = "timepoint")
plot_cme(lm(newsworthiness ~ engage * timepoint, d3_feed_cc_timed[topic=="willsmith"]), effect = "engage", condition = "timepoint")
