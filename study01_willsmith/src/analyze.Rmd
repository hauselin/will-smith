...
d3_b1_dwell_agg <- left_join(d0_feed_cc_agg, d3_b1_dwell[topic=="willsmith"]) |> data.table()
...
summaryh(lm(importance ~ dwellc * b1c, d3_b1_dwell_agg[topic=="willsmith"]))
summaryh(lm(newsworthiness ~ dwellc * b1c, d3_b1_dwell_agg[topic=="willsmith"]))
