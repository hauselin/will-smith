...
summaryh(lm(importance ~ dwell * timepoint, d3_feed_cc_timed[topic=="climate"]))
summaryh(lm(importance ~ engage * timepoint, d3_feed_cc_timed[topic=="climate"]))
summaryh(lm(newsworthiness ~ dwell * timepoint, d3_feed_cc_timed[topic=="climate"]))
summaryh(lm(newsworthiness ~ engage * timepoint, d3_feed_cc_timed[topic=="climate"]))


plot_cme(lm(importance ~ dwell * timepoint, d3_feed_cc_timed[topic=="climate"]), effect = "dwell", condition = "timepoint")
plot_cme(lm(importance ~ engage * timepoint, d3_feed_cc_timed[topic=="climate"]), effect = "engage", condition = "timepoint")
plot_cme(lm(newsworthiness ~ dwell * timepoint, d3_feed_cc_timed[topic=="climate"]), effect = "dwell", condition = "timepoint")
plot_cme(lm(newsworthiness ~ engage * timepoint, d3_feed_cc_timed[topic=="climate"]), effect = "engage", condition = "timepoint")
