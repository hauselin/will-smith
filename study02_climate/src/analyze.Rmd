...
d3
fwrite(d3, "../data/clean/data-model.csv")
```
...
d3_feed_cc_timed <- dcast(d3_feed_cc_timed[topic=="climate" & condition == 0.5], user_id + condition + topic + climate_perc + concern + desired_frequency + exposure_frequency + hope + human_activity + importance + newsworthiness + problem + rating_combined + climate_percC ~ timepoint, value.var = c("dwell", "engage"))

summaryh(lm(importance ~ dwell_1 * dwell_2 * dwell_3, d3_feed_cc_timed[topic=="climate"]))
summaryh(lm(newsworthiness ~ dwell_1 * dwell_2 * dwell_3, d3_feed_cc_timed[topic=="climate"]))
summaryh(lm(importance ~ engage_1 * engage_2 * engage_3, d3_feed_cc_timed[topic=="climate"]))
summaryh(lm(newsworthiness ~ engage_1 * engage_2 * engage_3, d3_feed_cc_timed[topic=="climate"]))





plot_cme(lm(importance ~ dwell_1 * dwell_2 * dwell_3, d3_feed_cc_timed[topic=="climate"]), effect = "dwell_2", condition = "dwell_3")
plot_cme(lm(newsworthiness ~ dwell_1 * dwell_2 * dwell_3, d3_feed_cc_timed[topic=="climate"]), effect = "dwell_2", condition = "dwell_3")
...
# dwell
correlation::cor_test(d3_b1_dwell[topic=="climate"], "importance", "b1")
correlation::cor_test(d3_b1_dwell[topic=="climate"], "newsworthiness", "b1")
correlation::cor_test(d3_b1_dwell[topic=="climate"], "importance", "b1", method = "spearman")
correlation::cor_test(d3_b1_dwell[topic=="climate"], "newsworthiness", "b1", method = "spearman")

d3_b1_dwell[, b0c := b0 - mean(b0, na.rm = T)]
d3_b1_dwell[, b1c := b1 - mean(b1, na.rm = T)]
summaryh(lm(importance ~ b0c * b1c, d3_b1_dwell[topic=="climate"]))
summaryh(lm(newsworthiness ~ b0c * b1c, d3_b1_dwell[topic=="climate"]))

mod_dwell_importance <- lm(importance ~ b0c * b1c, d3_b1_dwell[topic=="climate"])
plot_cme(mod_dwell_importance, effect = "b1c", condition = "b0c")

mod_dwell_newsworthiness <- lm(newsworthiness ~ b0c * b1c, d3_b1_dwell[topic=="climate"])
plot_cme(mod_dwell_newsworthiness, effect = "b1c", condition = "b0c")


# engage
correlation::cor_test(d3_b1_engage[topic=="climate"], "importance", "b1")
correlation::cor_test(d3_b1_engage[topic=="climate"], "newsworthiness", "b1")
correlation::cor_test(d3_b1_engage[topic=="climate"], "importance", "b1", method = "spearman")
correlation::cor_test(d3_b1_engage[topic=="climate"], "newsworthiness", "b1", method = "spearman")
...
mod_engage_importance <- lm(importance ~ b0c * b1c, d3_b1_engage[topic=="climate"])
plot_cme(mod_engage_importance, effect = "b1c", condition = "b0c")

mod_engage_newsworthiness <- lm(newsworthiness ~ b0c * b1c, d3_b1_engage[topic=="climate"])
plot_cme(mod_engage_newsworthiness, effect = "b1c", condition = "b0c")


ggplot(d3_b1_engage[topic=="climate"], aes(b0, importance)) + geom_point()
ggplot(d3_b1_engage[topic=="climate"], aes(b1, importance)) + geom_point()
```
