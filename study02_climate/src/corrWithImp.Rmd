...
d3 <- fread("../data/clean/data-model.csv")

d3_onlyTreatment <- d0_firstHeadline[condition == 0.5] |> inner_join(d3[topic == "climate"]) 
...
d3_onlyTreatment_b0s <- b0s |> inner_join(d3[topic == "climate"]) 
