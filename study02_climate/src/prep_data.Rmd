...
```{r}
d0 <- fread("../study02_climate/data/raw/eRGOfe_user_form.csv")
```
...
d2 <- get_data("../study02_climate/data/raw/eRGOfe_engagement.csv", n_entities = 100)
...
```{r ip quality}
ips <- copy(d3)
checked <- fread("../study02_climate/data/clean/ips_checked.csv")
...
```{r}
fwrite(dt_main2, "../study02_climate/data/clean/data.csv")
fwrite(dt_feed2, "../study02_climate/data/clean/data_feed.csv")
```
