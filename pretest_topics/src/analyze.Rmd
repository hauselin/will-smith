...
ggsave("../figures/plot_importance.png", plot_importance, dpi = 300, width = 13, height = 5, bg = "white")
ggsave("../figures/plot_newsworthy.png", plot_newsworthy, dpi = 300, width = 13, height = 5, bg = "white")
ggsave("../figures/plot_familiarity.png", plot_familiarity, dpi = 300, width = 13, height = 5, bg = "white")
ggsave("../figures/plot_observedFrequency.png", plot_observedFrequency, dpi = 300, width = 13, height = 5, bg = "white")
ggsave("../figures/plot_desiredFrequency.png", plot_desiredFrequency, dpi = 300, width = 13, height = 5, bg = "white")
...
ggsave("../figures/plot_importance_mean.png", plot_importance_mean, dpi = 300, width = 13, height = 5, bg = "white")
ggsave("../figures/plot_newsworthy_mean.png", plot_newsworthy_mean, dpi = 300, width = 13, height = 5, bg = "white")
ggsave("../figures/plot_familiarity_mean.png", plot_familiarity_mean, dpi = 300, width = 13, height = 5, bg = "white")
ggsave("../figures/plot_observedFrequency_mean.png", plot_observedFrequency_mean, dpi = 300, width = 13, height = 5, bg = "white")
ggsave("../figures/plot_desiredFrequency_mean.png", plot_desiredFrequency_mean, dpi = 300, width = 13, height = 5, bg = "white")
